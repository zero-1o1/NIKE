  ...
  return (
    <section className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container">
      ...
      <h2 className="font-palanquin text-4xl capitalize font-bold lg:max-w-lg">
        ...
        <p className="mt-6 lg:max-w-lg info-text">Navigate a realm of possibilites designed to fullfill your unique desires, surpassing the loftiest expectations, Your journey with us is nothing short of exceptional</p>
